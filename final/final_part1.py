...
def f(x): #Defines the function
    return np.log(x) #Returns the natural log of x

#Declares the bounds of 0 -> e and allows user to input N 
a = 1.0; b = np.e; N = input("Enter N: ")
...
axis.set_xlim([a-1, b]) #Creates Bounds for the x-axis
axis.set_ylim([a-1, b]) #Creates Bounds for the y-axis
...
y_mid = np.log(x_mid) #Y midpoints
